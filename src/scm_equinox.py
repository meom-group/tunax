"""
Single Column Model (SCM) time-stepping and oceanic equation of state.

References
----------
1. "edmf_ocean" available on GitHub at:
https://github.com/ManolisPerrot/edmf_ocean
"""
...
from python_src.scm_par_python import grav, cp


@jit
def advance_tra_ed(t_n, stflx, srflx, swr_frac, btflx, Hz, Akt, zw, eps, alpha,
                   dt):
    r"""
    ...
    return jnp.stack((temp, sal), axis=1)
