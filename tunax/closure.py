...
class Closure(eqx.Module, Generic[CloStateT, CloParT]):
    ...
    closure (child class of :class:`~ClosureStateAbstract`), the physical :class:`~case.Case`
    and the closure parameters (child class of :class:`~ClosureParametersAbstract`).
